...
import PropertySidebarTwo from '../../components/property-sidebar-two';
...
export default function ListLayoutWithMap() {
								...
								<div className="item-shorting-box">
									...
									<div className="item-shorting-box-right">
										...
										<ul className="shorting-list">
											<li>
												<Link to="/grid-layout-with-sidebar" className="w-12 h-12">
											...
											<li>
												<Link to="/listings-list-with-sidebar" className="active w-12 h-12">

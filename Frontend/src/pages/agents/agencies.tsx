        ...
        <div className="container">
                            ...
                            <div className="agents-grid card rounded-3 shadow">
                                <div className="agents-grid-wrap">
                                    <div className="fr-grid-thumb mx-auto text-center mt-5 mb-3">
                                        <Link to={`/agency-page/${item.id}`} className="d-inline-flex p-1 rounded border">
                                    ...
                                    <div className="fr-grid-deatil text-center">
                                        <div className="fr-grid-deatil-flex">
                                            ...
                                            <h5 className="fr-can-name mb-1 mt-2"><Link to={`/agency-page/${item.id}`}>{item.name}</Link></h5>
                                ...
                                <div className="fr-grid-info d-flex align-items-center justify-content-between px-4 py-4">
                                    <Link to={`/agency-page/${item.id}`}  className="btn btn-light-primary full-width">View Agency<i className="fa-solid fa-arrow-right-long ms-2"></i></Link>
                                </div>
                            </div>
                        </div>
                    )
            ...
            <div className="row">
                <div className="col-lg-12 col-md-12 col-sm-12 text-center mt-5">
                    <Link to="/listings-list-with-sidebar" className="btn btn-primary px-lg-5 rounded">Explore More Agencies</Link>
                </div>
            </div>
        </div>	
    </section>
